...
<head>
  ...
  <link rel="icon" href="img/reemplazo.png" type="image/x-icon"> <!--iCONO EN LA PESATAÑA DE CHROME-->
  <script
        ...
        function sendNotification() {
            if (Notification.permission === 'granted') {
                new Notification('¡Formulario Enviado!', {
                    body: 'Tu solicitud de Reemplazo ha sido enviada correctamente.',
  ...
  <div class="container">
    ...
    <div class="form">
      <div class="contact-info">
        <h3 class="title">Reemplazo</h3>
        <p class="text">
         Para realizar un reemplazo, se debe de realizar un soporte previo para realizar el cambio;  <br>
         tomando en cuenta <b>"La linea telefonica"</b>
         <br>-
    ...
    <form method="POST" action="guardar_solicitud.php" enctype="multipart/form-data">
        <h3 class="title">Solicitud de Reemplazo</h3>
          <br>
